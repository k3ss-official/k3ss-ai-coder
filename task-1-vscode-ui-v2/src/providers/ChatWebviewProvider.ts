...
export class ChatWebviewProvider implements vscode.WebviewViewProvider {
    public static readonly viewType = 'k3ss-ai-chat';
    ...
    constructor(private readonly _extensionUri: vscode.Uri, private readonly context: vscode.ExtensionContext) {
        ...
        this.cliManager = new CLIManager(context);
    ...
    private async handleChatMessage(message: string, settings?: any, history?: any[]) {
        try {
    ...
    private async getAIResponse(message: string, settings: any, history: any[]): Promise<string> {
    ...
    private async callOpenAI(message: string, settings: any, history: any[]): Promise<string> {
    ...
    private async callAnthropic(message: string, settings: any, history: any[]): Promise<string> {
    ...
    private async callOllama(message: string, settings: any, history: any[]): Promise<string> {
        ...
        const response = await (globalThis as any).fetch(`${ollamaEndpoint}/api/chat`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    private async getBuiltInResponse(message: string, history: any[]): Promise<string> {
    ...
    private generateCodeExample(type: string, request: string): string {
        const examples = {
...
Could you provide more specific details about what you'd like me to generate?`
        ...
        return examples[type as keyof typeof examples] || examples.general;
    }

    private analyzeCode(request: string): string {
...
What specific aspect would you like me to focus on?`;
    ...
    private performWebResearch(request: string): string {
...
What would you like me to research for you?`;
    ...
    private provideHelp(request: string): string {
...
How can I help you with your coding today?`;
    ...
    private getContextualResponse(message: string, history: any[]): string {
