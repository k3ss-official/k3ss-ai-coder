...
class ChatWebviewProvider {
    constructor(_extensionUri, aiAssistant) {
    ...
    async handleCodeGeneration(prompt, language) {
        try {
    ...
    async handleCodeAnalysis(code, language) {
        try {
...
ChatWebviewProvider.viewType = 'k3ss-ai.chatView';
